...
.main{
    margin:1% 0;
    background-image:linear-gradient(rgba(255, 190, 118,1.0),rgba(184,142,104,0.09));
        height: 100vh;
        ...
        <div class="main">
            <div class="wrapper">
                ...
                <table class="tb-full">
                        ...
                        {
                            $id=$_POST['id'];
                            $sql3="SELECT * FROM animal WHERE pet_id=$id";
                            ...
                            if($res==TRUE){
                                ...
                                if($count==1){
                                        ...
                                        <a href="<?php echo SITEURL;?>/updateanimal.php?id=<?php echo $id;?>" class="btn-primary">Update</a>
                                            <a href="<?php echo SITEURL;?>/deleteanimal.php?id=<?php echo $id;?>" class="btn-secondary">Delete</a>                                        </
                                        </td>
                                        </td>
                                    </tr>
